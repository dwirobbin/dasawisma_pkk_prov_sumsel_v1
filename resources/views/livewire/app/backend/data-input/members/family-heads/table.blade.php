        ...
        <div class="text-muted">
            <label>
                ...
                <select class="d-inline-block form-select w-auto" wire:model.live='perPage'>
                    ...
                    @if (count($this->familyHeads))
                        <option value="{{ $this->familyHeads->total() }}">Semua</option>
                    @endif
                </select>
                data
            </label>
            ...
            <div class="text-muted">
                <div class="dropdown-center btn-group" x-data="{ open: false }" x-on:click.outside="open = false">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" x-show="open" :class="{ 'show': open == true }" x-transition
                        ...
                        <li>
                            <button
                                wire:click="$dispatchTo('app.backend.data-input.members.family-heads.bulk-delete', 'confirm-bulk-delete', { ids: {{ json_encode($bulkSelected) }} })"
                                class="dropdown-item">
                                Hapus
                            </button>
                        </li>
