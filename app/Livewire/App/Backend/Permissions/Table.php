...
class Table extends Component
{
    ...
    #[Computed()]
    public function permissions(): LengthAwarePaginator|Collection
    {
    ...
    public function render(): View
    {
        ...
        ($this->permissions()->currentPage() <= $this->permissions()->lastPage())
            ? $this->setPage($this->permissions()->currentPage())
            : $this->setPage($this->permissions()->lastPage());
